            ...
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-3xl md:text-5xl font-black text-gray-900 mb-6 tracking-tight">
                        Our Regional <span class="text-primary-600">Presence</span>
                    </h2>
                    <p class="text-gray-500 max-w-2xl mx-auto font-medium">
                        Connecting businesses with premium European travel solutions across major Indian cities.
                    </p>
                </div>
